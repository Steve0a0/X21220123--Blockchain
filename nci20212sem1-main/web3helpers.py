...
# this function transfer the token from the user(mention in the .env file) to the account mention in the CURL command.
...
# this function transfer the etherum amount given in the CURL command from the user(mention in the .env file) to the account mention in the CURL command.
